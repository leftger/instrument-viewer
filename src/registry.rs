...
fn builtin_profiles() -> Vec<InstrumentProfile> {
    [
        ...
        include_str!("../profiles/hantek-hdm3000.yaml"),
        include_str!("../profiles/hantek-daq4000a.yaml"),
        include_str!("../profiles/hantek-hrdo2000.yaml"),
        include_str!("../profiles/siglent-ssa.yaml"),
...
fn driver_for(name: &str, idn: &str) -> Option<Box<dyn Backend>> {
    match name {
        ...
        "hdm3000" => Some(Box::new(crate::hdm3000::Hdm3000::from_idn(idn))),
        "daq4000a" => Some(Box::new(crate::daq4000a::Daq4000a::from_idn(idn))),
        "hrdo2000" => Some(Box::new(crate::hrdo2000::Hrdo2000::from_idn(idn))),
        "siglent_ssa" => Some(Box::new(crate::siglent_ssa::SiglentSsa::from_idn(idn))),
